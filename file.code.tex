...
\pgfkeys{
	/dsdraw/file/structure/.cd,
	%
	hide offsets/.is if = ds@file@showstructureoffsets,
}
...
\newif\ifds@file@showstructureoffsets
...
\NewDocumentCommand{\ds@file@drawstructurerecord} {mm} {
	...
	% draw offsets
	\ifds@file@showstructureoffsets
	...
	\else
		\node[file offset, anchor = north east] at  (file offset)
