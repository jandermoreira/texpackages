		...
		\foreach \block in {0, ..., \@lastblock}{
			\path
				...
				in
					node[
%					fit = {
%						(\block * \ds@file@kbytewidth, \y{record} + 0.3em)
%						(\block * \ds@file@kbytewidth +
%							\ds@file@kbytewidth, \y{offset})
%						}
						] {A};
%			\draw [draw = yellow, xshift = -0.05em]
%				(\block * \ds@file@kbytewidth, 1em)
%				rectangle
%				(\block * \ds@file@kbytewidth + \ds@file@kbytewidth, -1em);
		}
	\end{scope}
}
