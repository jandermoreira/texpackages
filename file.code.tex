...
% \ds@file@drawrecord: draw a single record in a structure file
%	#1: 
...
\ExplSyntaxOn
% ds@file@namedhelper: auxiliary to loop through a list of records
%	#1: record name (see \dsnewnamedrecord)
%	#2: a comma-separated list of records (fields contents/options)
\NewDocumentCommand{\ds@file@namedhelper}{mm}{
...
%	records and sizes
%	#1: comma-separated list of pairs record-lable/size-in-bytes
\NewDocumentCommand{\ds@file@filestructurehelper} {m} {
	\clist_map_function:nN {#1} \ds@file@drawrecord
}
\ExplSyntaxOff
