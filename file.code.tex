...
\pgfkeys{
	...
	kbyte width/.code = {
		\pgfmathparse{#1/1024}
		\edef\ds@file@bytewidth{\pgfmathresult pt}
	},
	%
...
%	\pgfmathparse{#2 * \ds@file@kbytewidth}
%	\def\@nodewidth{\pgfmathresult pt}
%	\node[file record h, text width = \@nodewidth] {#1};
	\node[file record h] {(#1)(#2)};
}
